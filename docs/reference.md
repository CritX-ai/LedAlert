...
LedAlert supports **Linux x86_64, KDE Plasma on Wayland, and one WLED RGB controller with its mapped strip**. See [Compatibility](support.md) for requirements and limits.
